...
import ExpandableSection, { AdBanner } from "@/components/ExpandableSection";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            ...
            <section id="microsoft" className="mb-12">
              ...
              <ExpandableSection title="История Microsoft" initialExpanded={false} variant="blue">
            ...
            <section id="unreleased">
              ...
              <ExpandableSection title="Непройденный путь: Windows, которых никогда не было" initialExpanded={false} variant="orange">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="border-2 border-blue-700 rounded overflow-hidden shadow-md bg-blue-50">
              <div className="bg-gradient-to-r from-blue-700 to-blue-500 text-white p-2">
                <h3 className="font-bold">Рекомендуем</h3>
              </div>
              <div className="p-4 space-y-4">
                <AdBanner 
                  title="Office XP"
                  description="Испытайте новейшие возможности для повышения производительности"
                  imageUrl="/lovable-uploads/5260188c-a4ec-4208-b35c-58d999189fbd.png"
                ...
                <AdBanner 
                  ...
                  description="Самый быстрый и безопасный способ просмотра интернета"
                  imageUrl="/lovable-uploads/5260188c-a4ec-4208-b35c-58d999189fbd.png"
                  linkUrl="https://www.microsoft.com"
                  variant="orange"
                />
                ...
                <AdBanner 
                  title="MSN Messenger"
                  description="Общайтесь с друзьями в режиме реального времени"
                  imageUrl="/lovable-uploads/5260188c-a4ec-4208-b35c-58d999189fbd.png"
                  linkUrl="https://www.microsoft.com"
                  variant="green"
                />
                ...
                <AdBanner 
                  title="Xbox"
                  description="Новое поколение игр уже здесь!"
                  imageUrl="/lovable-uploads/5260188c-a4ec-4208-b35c-58d999189fbd.png"
                  linkUrl="https://www.microsoft.com"
                  variant="red"
                />
            ...
            <div className="border-2 border-green-700 rounded overflow-hidden shadow-md bg-green-50">
              <div className="bg-gradient-to-r from-green-700 to-green-500 text-white p-2">
                <h3 className="font-bold">Партнеры</h3>
              </div>
              <div className="p-4 space-y-4">
                <AdBanner 
                  title="Intel Pentium 4"
                  description="Невероятная производительность для Windows XP"
                  imageUrl="/lovable-uploads/5260188c-a4ec-4208-b35c-58d999189fbd.png"
                ...
                <AdBanner 
                  ...
                  description="Видеокарты для лучшего опыта в Windows"
                  imageUrl="/lovable-uploads/5260188c-a4ec-4208-b35c-58d999189fbd.png"
                  linkUrl="https://www.nvidia.com"
                  variant="green"
                />
              </div>
            </div>
